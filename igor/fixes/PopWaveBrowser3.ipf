...
// ferv edit: just the location of panel (outdated)
...
variable screenright = Str2num(StringFromList(3,info2))
variable screenbottom = Str2num(StringFromList(4,info2))
...
If (WinType("PoPBrowser"))
	...
	NewPanel /K=2 /N=PoPBrowser /W = (left-halfwidth,top-halfheight,left+halfwidth, top+halfheight) as "Pop Bowser"
